...
- **Languages:** Python, R Programming, SQL, SAS, C/C++, PowerBI, Excel
- **ML & AI Frameworks:** TensorFlow, scikit-learn, PyTorch, Hugging Face Transformers
...
- 📂 [Resume](https://drive.google.com/file/d/1yW_FNtYN-DXkTY0KknpxC0IHrmV39d3O/view?usp=drive_link) *(upload to your GitHub or link a cloud-hosted PDF)*
...
<!--
**ChittyAbhiram/ChittyAbhiram** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
